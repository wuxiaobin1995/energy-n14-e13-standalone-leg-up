 ...
 * @LastEditTime: 2024-04-10 14:36:54
          ...
          import('@/utils/Export2Excel.js')
            .then(excel => {
              const excelTitle = {
                ...
                trainPart: '训练部位',
                bearWeight: '负重kg',
                leftWeightAverage: '左腿平均负重kg',
                rightWeightAverage: '右腿平均负重kg',
                resultRate: '完成度%'
              }
              const tHeader = Object.values(excelTitle)
              // 会根据key键的顺序、属性值等动态变化
