 ...
 * @LastEditTime: 2022-07-20 17:14:27
 * @Description : 肌耐力训练
-->
<template>
  <div class="muscular-endurance">
    <!-- 语音播放 -->
    ...
    <div class="left">
      ...
      <div class="introduce">
        <div class="item">
          训练要求：推荐使用50～70%的负荷，尽量贴合绿色曲线，锻炼下肢肌耐力
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      audioSrc: path.join(__static, `narrate/mandarin/12-肌耐力训练.mp3`),
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          ...
          trainType: JSON.stringify('肌耐力训练'),
          routerName: JSON.stringify('/mtt-select/muscular-endurance')
        }
      })
    },
