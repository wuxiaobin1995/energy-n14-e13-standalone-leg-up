 ...
 * @LastEditTime: 2022-07-26 10:01:31
 * @Description : 静态反馈训练
-->
<template>
...
export default {
  ...
  data() {
    return {
      ...
      imgSrc: require('@/assets/img/Mtt/Select/静态反馈训练.png'),
      setBgSrc: require('@/assets/img/Mtt/Select/参数设置背景.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/10-静态反馈训练.mp3`),
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          ...
          trainType: JSON.stringify('静态反馈训练'),
          routerName: JSON.stringify('/mtt-select/static-feedback')
        }
      })
    },
