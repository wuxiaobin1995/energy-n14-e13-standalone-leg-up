 ...
 * @LastEditTime: 2022-09-11 09:12:17
 * @Description : 自定义训练
-->
<template>
  <div class="custom">
...
export default {
  ...
  data() {
    return {
      ...
      imgSrc: require('@/assets/img/Train/Select/基础训练.png'), // 用基础训练的图作为展示即可
      setBgSrc: require('@/assets/img/Train/Select/参数设置背景2.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/9-自定义训练.mp3`),
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          ...
          trainType: JSON.stringify('自定义训练'),
          routerName: JSON.stringify('/train-select/custom')
        }
      })
    },
