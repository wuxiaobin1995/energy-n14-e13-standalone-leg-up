 ...
 * @LastEditTime: 2022-07-08 17:35:55
 * @Description : 离心训练
-->
<template>
  <div class="offcenter">
...
export default {
  ...
  data() {
    return {
      ...
      imgSrc: require('@/assets/img/Train/Select/离心训练.png'),
      setBgSrc: require('@/assets/img/Train/Select/参数设置背景1.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/7-离心训练.mp3`),
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          ...
          trainType: JSON.stringify('离心训练'),
          routerName: JSON.stringify('/train-select/offcenter')
        }
      })
    },
