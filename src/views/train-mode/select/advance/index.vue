 ...
 * @LastEditTime: 2022-09-11 09:19:11
 * @Description : 进阶训练
-->
<template>
  <div class="advance">
...
export default {
  ...
  data() {
    return {
      ...
      imgSrc: require('@/assets/img/Train/Select/进阶训练.png'),
      setBgSrc: require('@/assets/img/Train/Select/参数设置背景1.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/6-进阶训练.mp3`),
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          ...
          trainType: JSON.stringify('进阶训练'),
          routerName: JSON.stringify('/train-select/advance')
        }
      })
    },
