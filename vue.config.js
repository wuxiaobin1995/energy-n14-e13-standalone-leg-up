/*
 * @Author      : Mr.bin
 * @Date        : 2022-06-23 08:53:21
 * @LastEditTime: 2022-10-08 10:24:10
 * @Description : vue.config.js
 */

const projectName = 'energy-n14-e13-standalone-leg-up' // 项目名称，是一个程序的唯一标识符
const softwareName = '下肢蹬伸肌力检测软件-单机版' // 软件名称
